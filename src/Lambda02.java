...
public class Lambda02 {
    ...
    public static void main(String[] args) {
        ...
        //MAP : aksiyon öncesi elemanlar aksiyon sonrası degişime ugrar
        ciftKarePrint(sayi);
        System.out.println("\n *********");
...
//Optional ==> CompileTime'da java bunu tahmin ettiginde Java bunu zorlar.
// bunu onlemek icin optional yapisi geldi
    }
